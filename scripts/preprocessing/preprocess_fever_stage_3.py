...
from esim.data_fever_stage_3 import Preprocessor
...
def preprocess_FEVER_data(inputdir,
    ...
    train_file = 'stage_3_train_one_from_every_claim_data.pkl'
    dev_file = 'stage_3_validation_one_from_every_claim_data.pkl'
    test_file = 'stage_3_dev_one_from_every_claim_data.pkl'
#     train_file = ""
#     dev_file = ""
#     test_file = ""
...
if __name__ == "__main__":
    default_config = "../../config/preprocessing/fever_preprocessing_stage_3.json"
